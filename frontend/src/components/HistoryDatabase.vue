...
const selectedProject = ref(null) // project（）
let observer = null
...
// environmentconfiguration（Simulation）
...
const loadHistory = async () => {
  try {
    ...
    console.error('projectfailed:', error)
    projects.value = []
  } finally {
    loading.value = false
  }
...
/* */
.status-icon:nth-child(1).available { color: #3B82F6; } /* graph - */
...
/* status */
.card-progress.completed { color: #10B981; } /* completed - */
