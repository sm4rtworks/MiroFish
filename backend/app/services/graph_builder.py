...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # Pydantic v2 Field(default=None) Warning
        # Zep SDK ，Warningcreate，
        ...
        for entity_def in ontology.get("entity_types", []):
            ...
            # createtype（Pydantic v2 ）
            attrs = {"__doc__": description}
            annotations = {}
            
            for attr_def in entity_def.get("attributes", []):
                attr_name = safe_attr_name(attr_def["name"]) # name
                attr_desc = attr_def.get("description", attr_name)
                # Zep API Field description，
                attrs[attr_name] = Field(description=attr_desc, default=None)
                annotations[attr_name] = Optional[EntityText] # type
        ...
        for edge_def in ontology.get("edge_types", []):
            ...
            for attr_def in edge_def.get("attributes", []):
                ...
                # Zep API Field description，
                attrs[attr_name] = Field(description=attr_desc, default=None)
                annotations[attr_name] = Optional[str] # edgestrtype
    ...
    def add_text_batches(
        ...
        """graph，return episode uuid list"""
        episode_uuids = []
        total_chunks = len(chunks)
    ...
    def _wait_for_episodes(
        ...
        """waiting episode （query episode processed status）"""
