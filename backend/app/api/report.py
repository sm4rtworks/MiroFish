...
def generate_report():
    """
    simulationreport（task）
    
    ，APIreturntask_id，
     GET /api/report/generate/status query
    ...
    try:
        ...
        def run_generate():
            ...
            try:
                ...
                logger.error(f"reportfailed: {str(e)}")
        ...
        logger.error(f"startreporttaskfailed: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
...
def get_generate_status():
    ...
    request（JSON）：
        {
            "task_id": "task_xxxx", // optional，generatereturntask_id
...
def list_reports():
    ...
    Query：
        simulation_id: simulationID（optional）
...
def get_report_sections(report_id: str):
    ...
    frontendroundAPIgetcontent，nonewaitingreport
...
...
    ...
    try:
        ...
        logger.error(f"getlistfailed: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def get_single_section(report_id: str, section_index: int):
    ...
    try:
        ...
        logger.error(f"getcontentfailed: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def check_report_status(simulation_id: str):
    ...
    try:
        ...
        logger.error(f"reportstatusfailed: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def get_agent_log(report_id: str):
    ...
    Query：
        from_line: read（optional，default0，get）
...
def get_console_log(report_id: str):
    ...
    getreport（INFO、WARNING），
     agent-log APIreturn JSON log，
    log。
    ...
    return：
        {
            ...
            "data": {
                "logs": [
                    "[19:46:14] INFO:: 15 ",
                    "[19:46:14] INFO: graph: graph_id=xxx, query=...",
...
                ],
                "total_lines": 100,
                "from_line": 0,
    ...
    try:
        ...
        logger.error(f"getlogfailed: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def search_graph_tool():
    ...
    try:
        ...
        logger.error(f"graphfailed: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
